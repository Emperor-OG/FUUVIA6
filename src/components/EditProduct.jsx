...
export default function EditProductModal({
  ...
  const MARKUP_PERCENT = parseFloat(import.meta.env.VITE_MARKUP_PERCENTAGE || 11.25); // ✅ read from .env
  ...
  // ✅ Dynamic markup calculation using env variable
          ...
          {variants.map((v, i) => (
            <div key={i} className="variant-block">
              ...
              <input
                ...
                accept="image/*"
                onChange={(e) =>
                  handleVariantImageChange(i, e.target.files[0])
                }
              />
              {v.preview && (
                <img
              ...
              {v.existingImage && (
                <div className="existing-variant-img">
                  ...
                  <button
                    type="button"
                    onClick={() => removeExistingVariantImage(i)}
                  >
                    &times;
                  </button>
                </div>
